    ...
    , function(module, exports, __webpack_require__) {
        ...
        var Colorpicker = function() {
            ...
            function Colorpicker(element, options) {
                ...
                this.element = (0,
                _jquery2.default)(element).addClass("colorpicker-element").attr("data-colorpicker-id", this.id);
                ...
                this.container = this.container !== false ? (0,
                _jquery2.default)(this.container) : false;
                ...
                this.init();
                (0,
                _jquery2.default)(_jquery2.default.proxy(function() {
    ...
    , function(module, exports, __webpack_require__) {
        ...
        var Preview = function(_Extension) {
            ...
            function Preview(colorpicker) {
                ...
                _this.element = (0,
                _jquery2.default)(_this.options.template);
        ...
        var Swatches = function(_Palette) {
            ...
            _createClass(Swatches, [{
                ...
                value: function onCreate(event) {
                    ...
                    this.element = (0,
                    _jquery2.default)(this.options.barTemplate);
                    this.load();
                    this.colorpicker.picker.append(this.element)
                }
            }, {
                ...
                value: function load() {
                    ...
                    _jquery2.default.each(this.colors, function(name, value) {
                        var $swatch = (0,
                        _jquery2.default)(_this2.options.swatchTemplate).attr("data-name", name).attr("data-value", value).attr("title", isAliased ? name + ": " + value : value).on("mousedown.colorpicker touchstart.colorpicker", function(e) {
                            var $sw = (0,
                            _jquery2.default)(this);
                    ...
                    swatchContainer.append((0,
                    _jquery2.default)('<i class="colorpicker-clear"></i>'))
                }
            }]);
            return Swatches
        }(_Palette3.default);
        ...
        var SliderHandler = function() {
            ...
            _createClass(SliderHandler, [{
                ...
                value: function unbind() {
                    (0,
                    _jquery2.default)(this.colorpicker.picker).off({
                ...
                value: function pressed(e) {
                    ...
                    (0,
                    _jquery2.default)(this.colorpicker.picker).on({
                        "mousemove.colorpicker": _jquery2.default.proxy(this.moved, this),
                        "touchmove.colorpicker": _jquery2.default.proxy(this.moved, this),
                        "mouseup.colorpicker": _jquery2.default.proxy(this.released, this),
                        "touchend.colorpicker": _jquery2.default.proxy(this.released, this)
        ...
        var PopupHandler = function() {
            ...
            _createClass(PopupHandler, [{
                ...
                value: function bind() {
                    ...
                    (0,
                    _jquery2.default)(this.root).on("resize.colorpicker", _jquery2.default.proxy(this.reposition, this))
                }
            }, {
                key: "unbind",
                value: function unbind() {
                    ...
                    (0,
                    _jquery2.default)(this.root).off("resize.colorpicker", _jquery2.default.proxy(this.reposition, this));
                    (0,
                    _jquery2.default)(this.root.document).off("mousedown.colorpicker touchstart.colorpicker", _jquery2.default.proxy(this.hide, this));
                    (0,
                    _jquery2.default)(this.root.document).off("mousedown.colorpicker touchstart.colorpicker", _jquery2.default.proxy(this.onClickingInside, this))
                }
            }, {
                ...
                value: function createPopover() {
                    ...
                    this.popoverTip = (0,
                    _jquery2.default)(this.popoverTarget.popover("getTipElement").data("bs.popover").tip);
                ...
                value: function fireShow() {
                    ...
                    if (this.isPopover) {
                        (0,
                        _jquery2.default)(this.root.document).on("mousedown.colorpicker touchstart.colorpicker", _jquery2.default.proxy(this.hide, this));
                        (0,
                        _jquery2.default)(this.root.document).on("mousedown.colorpicker touchstart.colorpicker", _jquery2.default.proxy(this.onClickingInside, this))
                    }
