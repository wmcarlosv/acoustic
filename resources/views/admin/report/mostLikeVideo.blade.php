...
<section class="section">
    ...
    @include('layouts.breadcrumb', [
            'title' => __('Most Liked Videos'),
            'headerData' => __('Report'),
            'url' => 'admin/report'
    ])
    @include('layouts.filter',[
        'url' => 'admin/report/most-liked-video'
    ])
            ...
            <div class="col-12 col-md-12 col-lg-12">
                <div class="card">
                    <div class="card-header d-felx justify-content-between">
                        <h4> {{__('Top 50 Most Liked Videos')}} </h4>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($videos as $video)
                                        <tr>
                                            ...
                                            <td> {{Carbon\Carbon::parse($video['created_at'])->format('Y-m-d H:i:s')}} </td>
