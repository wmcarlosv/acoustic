...
<body>
    <div id="main_loader">
        ...
        <div class="Preloader">
            <img src="{{asset('image/app/loader.gif')}}" alt="Preloader">
        </div>
    </div>
    <?php
    $errors = false;
    ...
    <div class="container">
        <div class="section">
            <div class="column is-6 is-offset-3">
                <center>
                    <h1 class="title" style="padding-top: 20px">Acoustic Installation </h1><br>
                </center>
                <div class="box">
                    <?php
                    switch ($step) {
 ...
 please set 1</div>";
                    ...
                    <form action="{{url("installer")}}?step=1" method="POST">
                        ...
                        <div style='text-align: right;'>
                            <button type="submit" class="button db-import is-link">Import</button>
                                            ...
                                            $templine = '';
                                            $filename = public_path("acoustic.sql");
                                            $lines = file($filename);
                    ...
                    <?php
                            ...
                            ?>
                    <center>
                        <p><strong>Set your Admin Credential or use default.</strong></p><br>
                    </center>
    ...
    <div class="content has-text-centered">
        <p>© <?php echo date('Y'); ?> Copyright by Acoustic.</p><br>
    </div>
</body>
